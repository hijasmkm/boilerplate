...
function copyFonts(cb) {
    gulp.src("src/assets/sass/fonts/**/*.+(eot|woff|woff2|ttf|otf)")
...
exports.default = series(nunjucks, css, js, imageMin, copyFonts, copyVideo, watch_files);

// 'gulp build' will build all assets but not run on a local server.
exports.build = parallel(nunjucksMinify, css, js, imageMin, copyFonts, copyVideo);
